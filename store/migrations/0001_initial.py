# Generated by Django 5.0.6 on 2024-08-22 15:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.TextField()),
                ('address', models.CharField(max_length=255)),
                ('commune', models.CharField(blank=True, editable=False, max_length=100)),
                ('zip_code', models.CharField(max_length=10)),
                ('total', models.FloatField(default=0.0)),
                ('date_commande', models.DateTimeField(auto_now_add=True)),
                ('num_tel', models.CharField(max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photos', models.ImageField(blank=True, null=True, upload_to='produits')),
